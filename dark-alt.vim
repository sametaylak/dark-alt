" Vim color file
" dark-alt
" Created by Samet Aylak with ThemeCreator (https://github.com/mswift42/themecreator)
...
exe 'hi rubyBoolean guifg='s:keyword
...
exe 'hi jsNumber guifg='s:number
exe 'hi jsKeyword guifg='s:keyword
...
" Vue Highlighting
exe 'hi vueKeyword guifg='s:keyword
exe 'hi vueFunction guifg='s:func
